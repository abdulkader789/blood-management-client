                    ...
                    <main className="p-6 sm:p-10 space-y-6">
                        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                            ...
                            <div className="flex flex-wrap items-start justify-end -mb-3">
                                <button onClick={() => handleRender('log')} className="inline-flex px-5 py-3 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3">
                        ...
                        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div onClick={() => handleRender('alldonators')} className="cursor-pointer">
                                    <span className="block text-2xl font-bold">{allusers.length}</span>
                                    <span className="block text-gray-500">Total Donators</span>
                                </div>
                            </div>
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
